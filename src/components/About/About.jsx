               ...
               <li className={styles.aboutItem}>
                  ...
                  <div className={styles.aboutItemText}>
                     ...
                     <p>
                        ...
                        optimized sites using React, ASP.NET and Laravel.
                     </p>
                  </div>
               </li>
               <li className={styles.aboutItem}>
                  ...
                  <div className={styles.aboutItemText}>
                     ...
                     <p>
                        ...
                        including the creation of serverless functions.
                     </p>
                  </div>
               </li>
               <li className={styles.aboutItem}>
                  ...
                  <div className={styles.aboutItemText}>
                     <h3>UI Designer</h3>
                     <p>
                        I have designed multiple landing pages and have created design systems as
                        well
                     </p>
                  </div>
               </li>
